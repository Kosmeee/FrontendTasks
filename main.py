...
class Test:
    ...
    def recieveMessage(self):
        while True:
            self.recv_msg = self.mysocket.recv(1024)
            self.a = self.mysocket.recv(1024)
            message = str(self.recv_msg.decode('utf-8'))
            ...
            if self.num == "Admin":
                ...
                if message.find != "wait":
                    ...
                    print("".join(["Do you want new user to join?", message.split('\n')[0], "? [YES/NO] "]))
    ...
    def sendMessage(self):
        while True:
            try:
                ...
                self.recieve_msg = self.mysocket.recv(1024)
                self.a = self.mysocket.recv(1024)
                if self.num == "Admin":
                    if self.waiting:
                        message, self.a = (
    ...
    def main(self):
        ...
        while True:
            ...
            _thread.start_new_thread(Test.recieveMessage, ())
